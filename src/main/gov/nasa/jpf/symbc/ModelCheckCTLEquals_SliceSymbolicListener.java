...
public class ModelCheckCTLEquals_SliceSymbolicListener extends SliceSymbolicListener {

	ArrayList<String> gmConst;

	public ModelCheckCTLEquals_SliceSymbolicListener(Config conf, JPF jpf) {
		super(conf, jpf);
		initPathConst();
	}
...
//			System.out.println("STUART contraint path is " + pp.toString());
	...
	private void initPathConst() {
		...
		gmConst.add("buttons.LoadCTLButton.pushed()V");
		gmConst.add("modelCheckCTL.view.ModelCheckCTLView$FormulaHandler.actionPerformed(LnoSwing/ActionEvent;)V");
		gmConst.add("modelCheckCTL.controller.ModelCheckCTLController.operationFormula(Ljava/lang/String;)V");
		gmConst.add("modelCheckCTL.model.ModelCheckCTLModel.parseFormula(Ljava/lang/String;)Z");
		gmConst.add("ctlParser.CTLParser.translate(Ljava/lang/String;)Ljava/lang/String;");
		gmConst.add("modelCheckCTL.model.ModelCheckCTLModel.modelViewFormulaNotify(Ljava/lang/String;)V");
