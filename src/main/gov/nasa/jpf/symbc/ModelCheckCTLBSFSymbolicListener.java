...
public class ModelCheckCTLBSFSymbolicListener extends BSFSymbolicListener {

	public ModelCheckCTLBSFSymbolicListener(Config conf, JPF jpf) {
		super(conf,jpf);
		startNodeName = "buttons.LoadCTLButton.pushed()V";
		finalNodeName = "modelCheckCTL.model.ModelCheckCTLModel.modelViewFormulaNotify(Ljava/lang/String;)V";
		searchPrefix = ".";		
	}
